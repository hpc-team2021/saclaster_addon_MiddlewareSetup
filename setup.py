...
if __name__ == "__main__":
    ...
    setup(
        ...
        packages = ["sacluster", "sacluster.lib", "sacluster.lib.command", "sacluster.lib.auth", "sacluster.lib.cls", "sacluster.lib.cls.construction", "sacluster.lib.cls.delete", "sacluster.lib.cls.modify", "sacluster.lib.cls.start", "sacluster.lib.cls.stop", "sacluster.lib.cls.config", "sacluster.lib.cls.ps", "sacluster.lib.def_conf", "sacluster.lib.notif", "sacluster.lib.others","sacluster.lib.addon","sacluster.lib.addon.setupIp","sacluster.lib.addon.mylib","sacluster.lib.addon.setupProxy"],
