...
token = "094d0a9e-acd2-4078-83ec-12b14eb084df"
token_secret = "NnEkiRs1iHGBn4Fdb13LvfuN1nxSfidRBU96KwWVEJQHXzVyMYkpB0sP7MRi60TS"
auth_info = base64.b64encode('{}:{}'.format(token, token_secret).encode('utf-8'))

ext_data = external_data(auth_info, info_list = [1,0,0,0], fp = "")
config_param = config_loading_main(ext_data, in_path ="/Users/takahirakeigo/hpc-team/zyuyo/products/sacluster/config/config_23.json" , info_list = [1,0,0,0], fp = "")
build_params = config_transformation(ext_data, config_param, api_index = True, f = "", info_list = [1,0,0,0])
main(build_params, auth_info, fp = "" , info_list = [1,0,0,0] , api_index = True)

build_params["username"] = username
build_params["password"] = password

#d_path = "/Users/tsukiyamashou/Documents"
#import json
#with open(d_path + '/test2.json', 'w') as f:
    #json.dump(build_params, f, indent=4)

config_param["Monitor"]["Monitor key"] = "aaaaa"
preparing_monitor(ext_data, config_param, api_index = True, f = "", info_list = [1,0,0,0])
"""
