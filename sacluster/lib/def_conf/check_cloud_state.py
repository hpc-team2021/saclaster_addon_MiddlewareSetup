...
def check_cloud_state(ext_info, auth_info, info_list = [1,0,0,0], fp = "", api_index = True, func_type = ""):
    if(api_index == True):
        ...
        for zone in all_zone:
            ...
            if(ext_info["Zone"][zone]["maximum"] <= ext_info["Zone"][zone]["minimum"] and func_type == "build"):
