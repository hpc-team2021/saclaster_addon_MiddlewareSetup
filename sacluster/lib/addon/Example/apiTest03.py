        ...
        if(len(node_list) != 0):
            for i in range(len(node_list)):
                ...
                if (len(node_list[i]["Tags"]) > 0):
                    print('zone: ' + zone + ' | ' + node_list[i]["Tags"][0]   + ' | nodeID: ' + node_list[i]["ID"] + ' ---> diskID: ' + node_list[i]['Disks'][0]['ID'] + ' | nodeName: ' + node_list[i]['Name'])
                else:
                    print('zone: ' + zone + ' | ' + 'cluster ID: ' + ' NULL ' + ' | nodeID: ' + node_list[i]["ID"] + ' ---> diskID: ' + node_list[i]['Disks'][0]['ID'] + ' | nodeName: ' + node_list[i]['Name'])
        else:
            pass
