...
def switchFWZone(clusterID, params, nodePassword, jsonAddonParams):
...
if __name__ == '__main__':
    ...
    switchFWZone(clusterID = '108477', params=params, nodePassword = 'test', jsonAddonParams = jsonAddonParams)
